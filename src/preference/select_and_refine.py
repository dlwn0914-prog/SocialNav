...
def refine_towards_preference(waypoints, target, w, agent_positions=None, num_steps=5, lr=None, eps=1e-3, scale=None):
...
def select_and_refine(w, candidates, target, agent_positions=None, num_refine_steps=5, refine_lr=None, scale=None):
